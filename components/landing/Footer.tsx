                ...
                <div className="grid gap-12 lg:grid-cols-4">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-sm text-gray-500 leading-relaxed mb-6">
                            Real-time ad operations monitoring and analytics platform
                            for modern advertising teams.
                        </p>
                        <div className="flex items-center gap-4">
                            {/* Social Icons Placeholder */}
                            <a href="#" className="h-8 w-8 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 transition-colors">
